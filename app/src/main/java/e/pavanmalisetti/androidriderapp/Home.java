...
import e.pavanmalisetti.androidriderapp.Helper.CustomInfoWindow;
import e.pavanmalisetti.androidriderapp.Model.Notification;
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for(DataSnapshot postSnapshot:dataSnapshot.getChildren()){
                            ...
                            Sender sender = new Sender(notification,token.getToken()); //send this notification to token
...
//RidersInformation=>Table store information about User who register from Rider App
//DriversInformation=>Table store information about Driver who register from Driver app